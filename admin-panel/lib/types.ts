...
export type ServiceLocationRevision = Pick<ServiceLocation, "active" | "sales_available" | "delivery_available" | "installation_available" | "maintenance_available" | "mobilization_required" | "requires_inspection"> & {
  id: string;
  location_id: string;
