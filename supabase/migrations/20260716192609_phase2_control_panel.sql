...
grant select on public.published_product_prices to anon, authenticated;
grant select on public.discount_campaigns to anon, authenticated;
grant select on public.discount_campaign_products to anon, authenticated;
grant select on public.site_settings to anon, authenticated;
grant select on public.service_locations to anon, authenticated;
