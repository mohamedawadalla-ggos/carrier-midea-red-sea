...
Apply migrations in filename order. Do not rewrite an applied migration. After applying the location-revision migration, run `supabase/tests/phase2_control_panel_assertions.sql` and the live anonymous/staff RLS matrix before promoting the database change.
